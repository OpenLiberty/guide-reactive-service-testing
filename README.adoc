...
Next, run the following command to pull the latest Docker image:
...
If you have not pulled the latest Docker image yet, do so by running the following command:
