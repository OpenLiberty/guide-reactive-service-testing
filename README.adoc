...
:page-description: Learn how to use Kafka client APIs and MicroShed Testing to test reactive messaging microservices.
...
Learn how to use Kafka client APIs and MicroShed Testing to test a MicroProfile Reactive Messaging application.
