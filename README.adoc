...
*What is reactive messaging?*

Reactive messaging allows for the asynchronous processing and receiving of messages between services. By decoupling the
requests sent by a microservice from the responses that it receives, the microservice is not blocked from performing other
tasks while waiting for the requested data to become available.
