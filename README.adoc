...
[role='command']
```
mvnw.cmd -pl system liberty:devc
```
--
...
[role='command']
```
mvnw.cmd -pl system clean verify
```
--
...
[role='command']
```
mvnw.cmd -pl inventory liberty:devc
```
--
...
[role='command']
```
mvnw.cmd -pl inventory clean verify
```
--
