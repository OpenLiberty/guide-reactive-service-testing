...
Navigate to the `start/kitchen` directory and run the following Maven goal to start Open Liberty in development mode:
...
Open Liberty is now listening for file changes and updates in real time. Now you can add your test files.
