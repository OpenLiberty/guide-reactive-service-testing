...
[hotspot=initFoodOrder file=4]`initFoodOrder()` method. The the
[hotspot=initFoodOrder file=4]`initFoodOrder()` method will publish back an `IN_PROGRESS` message to the
