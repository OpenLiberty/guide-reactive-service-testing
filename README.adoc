...
ifdef::cloud-hosted[]
In this IBM Cloud environment, you need to change the user home to ***/home/project*** directory and pre-create the ***logs*** directory by running the following command:
```bash
sudo usermod -d /home/project theia
mkdir -p /home/project/guide-reactive-service-testing/start/target/liberty/wlp/usr/servers/defaultServer/logs
chmod 777 /home/project/guide-reactive-service-testing/start/target/liberty/wlp/usr/servers/defaultServer/logs
```
