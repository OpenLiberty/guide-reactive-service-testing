...
environments by using containers with https://microshed.org/microshed-testing/[MicroShed Testing^]. MicroShed Testing runs
...
You need to have Docker installed. For installation instructions, refer to the
(https://docs.docker.com/engine/installation[official Docker documentation^]) You will build and run the microservices in
Docker containers. An installation of Apache Kafka is provided in another Docker container.
