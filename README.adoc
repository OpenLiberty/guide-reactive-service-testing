...
To replicate the testing environment in production, Testcontainers are employed to execute tests within an identical Kafka environment. Use the following command to initiate the Kafka service within a container:
[role='command']
```
