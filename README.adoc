...
With Open Liberty https://openliberty.io/docs/latest/development-mode.html[dev mode^], you can use MicroShed Testing to run tests on an already running Open Liberty server. Navigate to the `start/system` directory.
