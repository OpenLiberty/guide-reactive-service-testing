...
Upon detection of a local system service container, the initiation of the test container is bypassed. In this scenario, the testing is directed towards the service exported by the system service container operating in dev mode. In the event that a local service container is not detected, the testing framework proceeds to initiate the test container. 
